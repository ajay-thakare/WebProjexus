...
export default function Home() {
  return (
    <>
      <section className="min-h-[calc(100vh-72px)] pt-36 w-full md:pt-44 mt-[-70px] relative flex items-center justify-center flex-col">
        {/* grid */}
        ...
        <p className="text-center md:text-2xl">Run your agency, in one place</p>
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-20 mt-[-60]">
        ...
        <div className="flex justify-center gap-4 flex-wrap mt-6">
          {pricingCards.map((card) => (
            // Todo : connect free product from stripe

    ...
    <AlertDialog>
      <div className="flex flex-col">
        ...
        <Command className="rounded-lg bg-transparent">
          ...
          <CommandList>
            <CommandEmpty className="hidden data-[filtering=true]:block">
              No Results Found.
            </CommandEmpty>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-between">
                        <div className="flex flex-col">
                          {subaccount.name}
                          <span className="hidden sm:inline text-muted-foreground mt-4">
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className="text-left">
                          ...
                          delete subaccount and all data related to the
                          subaccount.
                        </AlertDialogDescription>
                      </AlertDialogHeader>

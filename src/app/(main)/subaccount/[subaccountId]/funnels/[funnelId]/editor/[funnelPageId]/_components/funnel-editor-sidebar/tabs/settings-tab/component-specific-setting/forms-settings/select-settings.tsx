...
const SelectSettings = (props: Props) => {
  ...
  const multiple = currentContent.multiple || false;
      ...
      <div className="space-y-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <Label htmlFor="multiple" className="text-xs text-muted-foreground">
              Multiple Selection
            </Label>
            <Switch
              id="multiple"
              ...
              onCheckedChange={(checked) =>
                handleSwitchChange("multiple", checked)
              }
            />
          </div>
        </div>
      ...
      <div className="space-y-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
        ...
        <div className="flex flex-col gap-2">
          <Label
            ...
            className="text-xs text-muted-foreground"
          >
            {multiple ? "Default Selected Options" : "Default Selected Option"}
          </Label>
          {multiple ? (
            <div className="space-y-2">
              {options.map((option: SelectOption) => (
                <div key={option.id} className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor={`default-${option.id}`} className="text-sm">
                    {option.label}
                  </label>
                </div>
              ))}
        ...
        <div className="space-y-3">
          <div className="flex flex-col gap-2">
            ...
            <Textarea
              ...
              value={helperText}
              onChange={handleChangeCustomValues}
              placeholder="Additional information about this select field"
